...
blackbox stateful_alu test_stateful_alu_1_0_blackbox {
    ...
    reg                       : reg_0;
    condition_lo              : (ipv4.pkt__br_tmp00+11)<0;
    condition_hi              : ((0-ipv4.pkt__br_tmp00)+alu_hi)<0;
    update_lo_1_predicate     : false;
    update_lo_1_value         : (22)-(0);
    update_lo_2_predicate     : (condition_hi);
    update_lo_2_value         : (ipv4.pkt_new_hop)+(alu_hi);
    update_hi_1_predicate     : false;
    update_hi_1_value         : (14)-(29);
