...
blackbox stateful_alu test_stateful_alu_0_4_blackbox {
    ...
    reg                       : reg_4;
    condition_lo              : ((ipv4.p_pkt_00-alu_lo)+28)==0;
    ...
    update_hi_2_value         : (ipv4.p_pkt_00)-(alu_hi);
    output_predicate          : 1;
    output_value              : 0;
...
blackbox stateful_alu test_stateful_alu_0_5_blackbox {
    ...
    reg                       : reg_5;
    condition_lo              : ((ipv4.p_pkt_0-0)+20) !=0;
    condition_hi              : ((0-alu_lo)+29) !=0;
