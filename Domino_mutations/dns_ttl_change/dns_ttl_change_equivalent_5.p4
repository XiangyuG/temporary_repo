...
blackbox stateful_alu test_stateful_alu_1_3_blackbox {
    ...
    reg                       : reg_3;
    condition_lo              : ((0-ipv4.p_seen00)-alu_hi)==0;
    condition_hi              : ((0-ipv4.p_ttl)+alu_lo)==0;
    update_lo_1_predicate     : false;
    update_lo_1_value         : (ipv4.p_seen00)-(13);
...
// Stateful ALU blackbox
blackbox stateful_alu test_stateful_alu_2_2_blackbox {
    
    
    reg                       : reg_2;
    condition_lo              : (((0-ipv4.p__br_tmp6)-alu_lo)+1)==0;
    condition_hi              : (((0-ipv4.p__br_tmp6)-0)+1)>0;
    update_lo_1_predicate     :  not ((condition_hi) or (condition_lo));
    update_lo_1_value         : (ipv4.p__br_tmp6)-(1);
...
// Stateful ALU Action
action test_stateful_alu_2_2_action () {
    test_stateful_alu_2_2_blackbox.execute_stateful_alu(0);
    // TODO: Replace 0 with appropriate value for array-based registers. The
    // appropriate value can be determined by parsing the .c file using the
    // Domino compiler.
}
...
@pragma stage 2
table test_stateful_alu_2_2_table {
    actions {
        test_stateful_alu_2_2_action;
    }
    default_action: test_stateful_alu_2_2_action;
}
...
control ingress {
    // Call all the required ALUs.
          ...
          apply(test_stateful_alu_2_2_table);
