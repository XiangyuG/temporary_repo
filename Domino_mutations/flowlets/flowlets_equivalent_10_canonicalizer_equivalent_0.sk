...
if (p.pkt_1-state_group_1_state_0>5&&1==1&&1==1) {state_group_0_state_0=p.pkt_0;
...
if (state_and_packet.pkt_1-state_and_packet.state_group_1_state_0>5&&1==1&&1==1) {state_and_packet.state_group_0_state_0=state_and_packet.pkt_0;
