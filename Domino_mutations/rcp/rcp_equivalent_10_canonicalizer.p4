...
blackbox stateful_alu test_stateful_alu_0_0_blackbox {
    ...
    reg                       : reg_0;
    condition_lo              : (((0-ipv4.p_pkt_1)-alu_lo)+11)==0;
    condition_hi              : ((0-ipv4.p_pkt_1)+29)<0;
...
blackbox stateful_alu test_stateful_alu_0_1_blackbox {
    ...
    update_lo_1_value         : (15)-(ipv4.p_pkt_0);
    ...
    update_hi_1_value         : (30)-(ipv4.p_pkt_0);
