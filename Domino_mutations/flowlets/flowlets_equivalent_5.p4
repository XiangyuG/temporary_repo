...
blackbox stateful_alu test_stateful_alu_0_1_blackbox {
    ...
    reg                       : reg_1;
    condition_lo              : ((0-ipv4.pkt_arrival)+6)==0;
...
blackbox stateful_alu test_stateful_alu_1_0_blackbox {
    ...
    reg                       : reg_0;
    condition_lo              : (((0-ipv4.pkt__br_tmp00)+alu_hi)+1) !=0;
    condition_hi              : ((0-ipv4.pkt__br_tmp00)-alu_lo)>0;
    update_lo_1_predicate     : (condition_hi) and (condition_lo);
    update_lo_1_value         : (9)-(27);
