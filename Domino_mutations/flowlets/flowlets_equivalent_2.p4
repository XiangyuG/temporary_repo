...
blackbox stateful_alu test_stateful_alu_0_1_blackbox {
    ...
    reg                       : reg_1;
    condition_lo              : (((0-ipv4.pkt_arrival)+alu_hi)+5)==0;
...
blackbox stateful_alu test_stateful_alu_1_0_blackbox {
    ...
    reg                       : reg_0;
    condition_lo              : (((0-ipv4.pkt__br_tmp00)-0)+1)==0;
    condition_hi              : (((0-ipv4.pkt_new_hop)-alu_lo)+1)==0;
    update_lo_1_predicate     :  not (condition_lo);
    update_lo_1_value         : (ipv4.pkt__br_tmp00)+(alu_lo);
    ...
    update_hi_2_value         : (ipv4.pkt_new_hop)+(19);
    output_predicate          : 1;
    output_value              : 0;
