...
blackbox stateful_alu test_stateful_alu_1_1_blackbox {
    ...
    update_lo_1_value         : (ipv4.p_seen00)-(alu_lo);
    update_lo_2_predicate     : true;
    update_lo_2_value         : (ipv4.p_ttl)+(alu_hi);
    update_hi_1_predicate     : false;
    update_hi_1_value         : (ipv4.p_ttl)+(alu_lo);
...
blackbox stateful_alu test_stateful_alu_2_3_blackbox {
    ...
    reg                       : reg_3;
    condition_lo              : ((0-ipv4.p__br_tmp8)-0)<0;
    condition_hi              : (((0-ipv4.p__br_tmp8)-alu_lo)+1)<0;
    update_lo_1_predicate     : (condition_hi) and (condition_lo);
    update_lo_1_value         : (ipv4.p__br_tmp8)-(1);
    update_lo_2_predicate     :  not (condition_lo);
    update_lo_2_value         : (ipv4.p__br_tmp7)+(alu_lo);
    update_hi_1_predicate     : (condition_hi) and (condition_lo);
    update_hi_1_value         : (ipv4.p__br_tmp7)-(alu_hi);
