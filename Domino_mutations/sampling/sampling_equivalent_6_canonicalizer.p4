...
header_type ipv4_t {
    fields {
        ...
        p__br_tmp50 : 32 (signed);   
        p__br_tmp60 : 32 (signed);   
        p__br_tmp00 : 32 (signed);   
        p_pkt_00 : 32 (signed);   
        p__br_tmp10 : 32 (signed);   
        p__br_tmp30 : 32 (signed);   
        p_pkt_01 : 32 (signed);   
        p_pkt_0 : 32 (signed);   
        p__br_tmp40 : 32 (signed);  
    }
}
...
blackbox stateful_alu test_stateful_alu_0_1_blackbox {
    ...
    update_hi_2_predicate     : (condition_hi) or ( not (condition_lo));
    update_hi_2_value         : 1;
    output_predicate          : 1;
    output_value              : 0;
    output_dst                : ipv4.p__br_tmp10;
...
// Stateful ALU blackbox
blackbox stateful_alu test_stateful_alu_0_4_blackbox {
...
// Stateful ALU Action
action test_stateful_alu_0_4_action () {
    test_stateful_alu_0_4_blackbox.execute_stateful_alu(0);
    // TODO: Replace 0 with appropriate value for array-based registers. The
    // appropriate value can be determined by parsing the .c file using the
    // Domino compiler.
}
...
// Stateful ALU table
@pragma ignore_table_dependency test_stateful_alu_0_4_table
@pragma stage 0
table test_stateful_alu_0_4_table {
    actions {
        test_stateful_alu_0_4_action;
    }
    default_action: test_stateful_alu_0_4_action;
}

  
    
// Stateful ALU blackbox
blackbox stateful_alu test_stateful_alu_0_5_blackbox {
...
// Stateful ALU Action
action test_stateful_alu_0_5_action () {
    test_stateful_alu_0_5_blackbox.execute_stateful_alu(0);
    // TODO: Replace 0 with appropriate value for array-based registers. The
    // appropriate value can be determined by parsing the .c file using the
    // Domino compiler.
}
...
// Stateful ALU table
@pragma ignore_table_dependency test_stateful_alu_0_5_table
@pragma stage 0
table test_stateful_alu_0_5_table {
    actions {
        test_stateful_alu_0_5_action;
    }
    default_action: test_stateful_alu_0_5_action;
}

  
    
// Stateful ALU blackbox
blackbox stateful_alu test_stateful_alu_0_6_blackbox {
    
    
    reg                       : reg_6;
    condition_lo              : ((0-alu_lo)+29) !=0;
    condition_hi              : (((0-ipv4.p_pkt_00)-alu_lo)+30)<0;
...
// Stateful ALU Action
action test_stateful_alu_0_6_action () {
    test_stateful_alu_0_6_blackbox.execute_stateful_alu(0);
    // TODO: Replace 0 with appropriate value for array-based registers. The
    // appropriate value can be determined by parsing the .c file using the
    // Domino compiler.
}
...
// Stateful ALU table
@pragma ignore_table_dependency test_stateful_alu_0_6_table
@pragma stage 0
table test_stateful_alu_0_6_table {
    actions {
        test_stateful_alu_0_6_action;
    }
    default_action: test_stateful_alu_0_6_action;
}

  
    
// Stateful ALU blackbox
blackbox stateful_alu test_stateful_alu_0_7_blackbox {
...
// Stateful ALU Action
action test_stateful_alu_0_7_action () {
    test_stateful_alu_0_7_blackbox.execute_stateful_alu(0);
    // TODO: Replace 0 with appropriate value for array-based registers. The
    // appropriate value can be determined by parsing the .c file using the
    // Domino compiler.
}
...
// Stateful ALU table
@pragma ignore_table_dependency test_stateful_alu_0_7_table
@pragma stage 0
table test_stateful_alu_0_7_table {
    actions {
        test_stateful_alu_0_7_action;
    }
    default_action: test_stateful_alu_0_7_action;
}
...
control ingress {
    // Call all the required ALUs.
          ...
          apply(test_stateful_alu_0_4_table);
        
      
        
          apply(test_stateful_alu_0_5_table);
        
      
        
          apply(test_stateful_alu_0_6_table);
        
      
        
          apply(test_stateful_alu_0_7_table);
