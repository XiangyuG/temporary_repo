...
blackbox stateful_alu test_stateful_alu_0_0_blackbox {
    ...
    update_hi_2_value         : (4)-(7);
    output_predicate          : 1;
    output_value              : 0;
    output_dst                : ipv4.p__br_tmp20;
