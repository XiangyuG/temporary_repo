...
blackbox stateful_alu test_stateful_alu_1_0_blackbox {
    ...
    reg                       : reg_0;
    condition_lo              : ((0-ipv4.pkt_new_hop)-alu_lo)>0;
    condition_hi              : ((0-ipv4.pkt__br_tmp00)-0)<0;
    ...
    update_lo_2_value         : (ipv4.pkt__br_tmp00)+(alu_lo);
    update_hi_1_predicate     : (condition_hi);
    update_hi_1_value         : (1)-(26);
    update_hi_2_predicate     : ( not (condition_hi)) and (condition_lo);
    update_hi_2_value         : (alu_hi)-(ipv4.pkt__br_tmp00);
    output_predicate          : 1;
    output_value              : 0;
