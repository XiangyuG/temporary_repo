...
blackbox stateful_alu test_stateful_alu_0_0_blackbox {
    ...
    reg                       : reg_0;
    condition_lo              : (((0-ipv4.p_pkt_1)+alu_hi)+30)>0;
    condition_hi              : (((0-ipv4.p_pkt_1)-alu_lo)+3)==0;
...
blackbox stateful_alu test_stateful_alu_0_2_blackbox {
    ...
    reg                       : reg_2;
    condition_lo              : ((0-ipv4.p_pkt_1)+30)>0;
    condition_hi              : (((0-ipv4.p_pkt_1)-alu_hi)+11)<0;
