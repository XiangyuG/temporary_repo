...
blackbox stateful_alu test_stateful_alu_0_0_blackbox {
    ...
    reg                       : reg_0;
    condition_lo              : ((ipv4.p_pkt_3-alu_lo)+1)>0;
    condition_hi              : (ipv4.p_pkt_4-alu_hi) !=0;
    ...
    update_hi_1_value         : (alu_lo)-(ipv4.p_pkt_3);
...
action test_stateless_alu_0_0_action () {
    ...
    modify_field(ipv4.p_pkt_20, ipv4.p_pkt_0);
...
action test_stateless_alu_0_1_action () {
    
    
    modify_field(ipv4.p_pkt_10, ipv4.p_pkt_0);
    
}

// Stateless ALU table
@pragma ignore_table_dependency test_stateless_alu_0_1_table
@pragma stage 0
table test_stateless_alu_0_1_table {
    actions {
        test_stateless_alu_0_1_action;
    }
    default_action:  test_stateless_alu_0_1_action;
}
...
control ingress {
    // Call all the required ALUs.
          ...
          apply(test_stateless_alu_0_1_table);
