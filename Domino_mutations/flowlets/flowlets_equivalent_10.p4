...
blackbox stateful_alu test_stateful_alu_0_1_blackbox {
    ...
    reg                       : reg_1;
    condition_lo              : ((0-ipv4.pkt_arrival)+3)>0;
...
blackbox stateful_alu test_stateful_alu_1_0_blackbox {
    ...
    reg                       : reg_0;
    condition_lo              : (ipv4.pkt__br_tmp00+alu_hi)>0;
    condition_hi              : (((0-ipv4.pkt_new_hop)-alu_lo)+5) !=0;
    ...
    update_hi_1_value         : (1)-(2);
    update_hi_2_predicate     : false;
    update_hi_2_value         : (31)+(26);
    output_predicate          : 1;
    output_value              : 0;
